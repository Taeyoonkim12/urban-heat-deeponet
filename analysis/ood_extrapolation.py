...
Usage:
    python analysis/ood_extrapolation.py --data-root data/dummy \
        --ood-dir data/dummy/cases --runs runs --models m0 m1 m2 m3 m4 m5 \
...
COLORS = {'m0': '#99bb77', 'm1': '#77aa55', 'm2': '#4477bb', 'm3': '#cc8833',
          'm4': '#333333', 'm5': '#cc4444', 'solar_control': '#8855aa'}
...
def main():
    ...
    ap.add_argument('--models', nargs='+', default=['m0', 'm1', 'm2', 'm3', 'm4', 'm5'])
    ...
    runs = {}
    union_spec = {k: False for k in ('use_dbp', 'use_category')}
